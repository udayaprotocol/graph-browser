        ...
        try {
            fetch(`./all_users.json`)
                ...
                newNodes.forEach((node) => {
                    ...
                    graph.addNode(node.id, Object.assign({}, node));
                });
